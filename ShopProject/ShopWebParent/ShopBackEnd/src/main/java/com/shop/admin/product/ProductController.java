...
public class ProductController {
	...
	public String listByPage(@PathVariable(name = "pageNum") Integer pageNum,
			...
			Model model) {
		Page<Product> page = productService.findAll(pageNum, sortField, sortDir, keyword);
	...
	public String updateEnabledStatus(@PathVariable(name = "id") Integer id, @PathVariable(name = "status") boolean status,
			RedirectAttributes redirectAttributes) {
		try {
			productService.updateEnabledStatus(id, status);
			redirectAttributes.addFlashAttribute("message", "Update Enabled Status Successfull");
		}catch(ProductNotFoundException ex) {
			redirectAttributes.addFlashAttribute("message", ex.getMessage());
		}
		return "redirect:/products";
