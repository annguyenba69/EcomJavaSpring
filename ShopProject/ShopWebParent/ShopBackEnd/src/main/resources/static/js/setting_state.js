...
function deleteState(){
	...
	$.ajax({
		...
		changeFormStateToNew();
		console.log("The state has been deleted");
	}).fail(function() {
...
function addState(){
	...
	$.ajax({
		...
		console.log("The new state has been added");
	}).fail(function(){
		console.log("ERROR: Could not connect to server or server encountered an error");
	})
}
...
function loadStates4Country(){
	...
	$.get(url, function(responseJSON){
		...
		changeFormStateToNew();
		console.log("All states have been loaded for country " + selectedCountry.text());
	}).fail(function(){
		console.log("ERROR: Could not connect to server or server encountered an error");
	})
}

function loadCoutries4States(){
